  ...
  return (
    <section id="best" className=" bg-white">
      <div className="bg-bgBest object-cover bg-center h-[600px] w-full">
        <div className="max-w-6xl mx-auto px-5 flex items-center flex-col justify-center h-full">
          {/* title */}
          <h3 className="text-center text-3xl md:text-5xl text-white font-semibold py-10 md:py-16">
            ..الكتب الاكثر مبيعاً
          </h3>
          {/* best books grid */}
          <div className=" grid grid-cols-2 w-fit mx-auto gap-2 md:gap-4 md:grid-cols-3 xl:grid-cols-4 overflow-hidden">
            {books.map((book, index) => {
              return (
                <div
                  key={index}
                  className="bg-white w-[130px] h-[130px] md:w-[180px] md:h-[180px] rounded-xl shadow-md text-center flex flex-col items-center justify-around px-5"
                >
