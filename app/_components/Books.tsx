...
export default function Books() {
  return (
    <div className="bg-white">
      <div className="max-w-6xl mx-auto px-2 md:px-5 pt-16">
        {/* header */}
        <div className="shadow-md grid grid-cols-3 bg-white">
          <div className="group py-2 px-1 md:p-3  flex items-center justify-center flex-col">
            <PiNotebookLight className="text-3xl text-primary mb-1" />
        ...
        {/* books */}
        <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 px-1 md:px-20 py-16 gap-5">
